...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 bg-gray-900 dark:bg-gray-50 dark:bg-opacity-10  bg-opacity-10 shadow-lg rounded-full px-4 py-2">
      <div className="flex items-center space-x-4">
        {sections.map((section) => (
          ...
          >
            <div className="p-3 text-gray-400 bg-[#0A192F]  rounded-full group-hover:bg-green-400 group-hover:bg-opacity-90    group-hover:text-white transition-all duration-300">
              {section.icon}
            </div>
        ...
        <div className="relative group mx-2">
          <div className="p-3 text-gray-400 bg-[#0A192F] rounded-full group-hover:bg-green-400 group-hover:text-white transition-all duration-300">
            <FaGlobe />
          </div>
        ...
        <div
          className="p-3 text-gray-400 bg-[#0A192F]  rounded-full cursor-pointer hover:bg-green-400 group-hover:text-white transition-all duration-300"
          onClick={changeTheme}
        >
